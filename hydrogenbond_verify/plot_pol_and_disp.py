...
ax1.plot(dis, E_tot, color='#FCBB44', linestyle='-', label='E_tot', linewidth=2)
ax1.plot(dis, E_tot_nn, color ='#FCBB44', linestyle='--', linewidth=2)
ax1.scatter(dis, E_tot, c='#FCBB44', s=20)
ax1.scatter(dis, E_tot_nn, c='#FCBB44', s=20)
...
#ax2 = ax1.twinx()
ax1.plot(dis, E1_pol, color = '#F1766D', linestyle='-', label='E_es', linewidth=2)
ax1.plot(dis, E1pol_nn, color='#F1766D', linestyle='--', linewidth=2)
ax1.scatter(dis, E1_pol, c='#F1766D', s=20)
ax1.scatter(dis, E1pol_nn, c='#F1766D', s=20)
...
#ax2.set_yticks([8,16,24,32]) 
#ax1.set_yticks([8,16,24,32]) 

# 37_250_37
#ax1.set_ylim([22,31])
#ax1.set_ylim([21,33])
#ax1.set_yticks([22,25,28,31])  
#ax2.set_yticks([22,25,28,31])  
...
#ax1.set_ylim([-70,-10])
#ax2.set_ylim([-50,-5])
#ax1.set_yticks([-70,-50,-30,-10])  
#ax2.set_yticks([-70,-50,-30,-10])  
#ax2.set_yticks([-50,-35,-20,-5]) 

# 37_74_74
#ax1.set_ylim([-12.5,-0.5])
#ax2.set_ylim([-7,-1])
#ax1.set_yticks([-12.5,-8.5,-4.5,-0.5])  
...
ax1.set_ylim([22,34])
#ax2.set_ylim([-7,-1])
ax1.set_yticks([22,26,30,34])  
#ax2.set_yticks([22,26,30,34])  
#ax2.set_yticks([-13,-9,-5,-1])  
#ax2.set_yticks([-7,-5,-3,-1]) 
