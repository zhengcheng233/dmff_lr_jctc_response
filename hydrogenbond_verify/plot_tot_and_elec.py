...
#ax2 = ax1.twinx()
ax1.plot(dis, E2_disp, color = '#F1766D', linestyle='-', label='E_es', linewidth=2)
ax1.plot(dis, E2disp_nn, color='#F1766D', linestyle='--', linewidth=2)
ax1.scatter(dis, E2_disp, c='#F1766D', s=20)
ax1.scatter(dis, E2disp_nn, c='#F1766D', s=20)
